...
<c:set var ="id" value="<%=id %>"/>
	...
	<c:if test = "${id != null}">
        ...
        <div class="sns"><img src="images/sns1.PNG" width="60" height="46" alt="sns" /></div>
      </div>
  ...
  <div id="main" onblur="MM_openBrWindow('popup.html','popup','menubar=yes,width=450,height=300')">
    ...
    <div id="m-banner">
      ...
      <div class="m_ban2"><a href="clothesInfo1.jsp?clothesId=1" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('2','','images/4-1.PNG',0)"><img src="images/2.PNG" width="400" height="400" id="2" /></a></div>
      <div class="m_ban3"><a href="clothesInfo1.jsp?clothesId=2" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('3','','images/5-1.PNG',1)"><img src="images/444.PNG" width="400" height="400" id="3" /></a></div>
      <div class="m_ban4"><a href="clothesInfo1.jsp?clothesId=3" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('4','','images/3-1.PNG',0)"><img src="images/3.jpg" width="400" height="400" id="4" /></a></div>
      <div class="m_ban1"><a href="clothesInfo1.jsp?clothesId=4" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('5','','images/6-1.PNG',0)"><img src="images/5555.PNG" width="400" height="400" id="5" /></a></div>
      <div class="m_ban2"><a href="clothesInfo1.jsp?clothesId=5" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('6','','images/7-1.PNG',0)"><img src="images/6666.PNG" width="400" height="400" id="6" /></a></div>
      <div class="m_ban3"><a href="clothesInfo1.jsp?clothesId=6" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('7','','images/9-1.PNG',0)"><img src="images/7777.PNG" width="400" height="400" id="7" /></a></div>
      <div class="m_ban4"><a href="clothesInfo1.jsp?clothesId=7" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('8','','images/10-1.PNG',1)"><img src="images/8888.PNG" width="400" height="400" id="8" /></a></div>
      <div class="m_ban1"><a href="clothesInfo1.jsp?clothesId=8" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('9','','images/11-1.PNG',1)"><img src="images/10.PNG" width="400" height="400" id="9" /></a></div> 
      <div class="m_ban2"><a href="clothesInfo1.jsp?clothesId=9" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('10','','images/12-1.PNG',1)"><img src="images/11.PNG" width="400" height="400" id="10" /></a></div>
      <div class="m_ban3"><a href="clothesInfo1.jsp?clothesId=10" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('11','','images/121.PNG',1)"><img src="images/12.PNG" width="400" height="400" id="11" /></a></div>
      <div class="m_ban4"><a href="clothesInfo1.jsp?clothesId=11" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('12','','images/8-1.PNG',1)"><img src="images/9.PNG" width="400" height="400" id="12" /></a></div>
